...
<div class="container-fluid" style="margin-top: 20px; margin-bottom: 50px">
    <x:form::form class="row" method="POST" :action="route('user.store.user')">
        ...
        <div class="col-md-6">
            ...
            <x:form::input name="respontel1" label="Telefone (1) do Responsável: " class="phone" :placeholder="false"/>
            <x:form::input name="respontel2" label="Telefone (2) do Responsável" class="phone" :placeholder="false"/>
