    ...
    <main>
        <div style="clear:both; position:relative">
            @foreach ($dados as $matricula)
                ...
                <p style="margin-top: -8px"><b>Mãe: </b>{{$matricula['aluno']->genitora}}</p>
                            ...
                            @foreach ($area['componentes'] as $componente)
                                <tr>
                                    ...
                                    @foreach ($componente['notas'] as $bimestre)
                                        <td>
                                        @php
                                            if($bimestre['periodo-media'] != "-"){
                                                if($bimestre['periodo-media'] >=0 && $bimestre['periodo-media'] <= 2.9){
                                                    echo "ING";
                                                }else if($bimestre['periodo-media'] > 2.9 && $bimestre['periodo-media'] <= 5.4){
                                                    echo "INS";
                                                }else if($bimestre['periodo-media'] > 5.4 && $bimestre['periodo-media'] <= 7.5){
                                                    echo "SUF";
                                                }else if($bimestre['periodo-media'] > 7.5 && $bimestre['periodo-media'] <= 9){
                                                    echo "BOM";
                                                }else if($bimestre['periodo-media'] > 9){
                                                    echo "OTI";
                                                }
                                            }else{
                                                echo $bimestre['periodo-media'];
                                            }
                                        @endphp</td>
                ...
                <p style="text-weight: normal; font-size: 8pt">Legenda: <br/>C (conceito); F (faltas); MF (média final); TF (total de faltas); CHP (carga-horária prevista); CHC (carga-horária cursada); RF (resultado final).</p>
                <br/>
